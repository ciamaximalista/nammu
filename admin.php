...
";
        ...
        if ($redirectUrlRaw !== '' && preg_match($pattern, $redirectUrlRaw)) {
            ...
            $allowedPages = ['resources','publish','edit','edit-post','template','itinerarios','itinerario','itinerario-tema','configuracion'];
                ...
                <?php endif; ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right">
                                                                    <div class="text-right">
                                                                        ...
                                                                        <div class="mb-2">
                                                                            <a class="btn btn-sm btn-outline-secondary" href="?page=itinerario-tema&itinerary=<?= urlencode($itineraryItem->getSlug()) ?>#topic-form">Temas</a>
                                                                        </div>
                        ...
                        <?php elseif ($page === 'itinerario-tema'): ?>
                            ...
                            <div class="tab-pane active">
                                <div class="d-flex flex-wrap align-items-center justify-content-between mb-3 gap-2">
                                    <div>
                                        <h2 class="mb-1">Temas del itinerario</h2>
                                        <p class="text-muted mb-0"><?= $selectedItinerary ? htmlspecialchars($selectedItinerary->getTitle(), ENT_QUOTES, 'UTF-8') : 'Selecciona un itinerario para gestionar sus temas.' ?></p>
                                    </div>
                                    <div class="btn-group">
                                        <a class="btn btn-outline-secondary" href="?page=itinerarios">Volver al listado</a>
                                        <?php if ($selectedItinerary): ?>
                                            <a class="btn btn-outline-secondary" href="?page=itinerario&itinerary=<?= urlencode($selectedItinerary->getSlug()) ?>#itinerary-form">Editar itinerario</a>
                                            <a class="btn btn-primary" href="?page=itinerario-tema&itinerary=<?= urlencode($selectedItinerary->getSlug()) ?>&topic=new#topic-form">Nuevo tema</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <?php if (!$selectedItinerary): ?>
                                    <div class="alert alert-info">Selecciona un itinerario desde el listado para gestionar sus temas.</div>
                                <?php else: ?>
                                    <div class="card mb-4">
                                        <div class="card-body itinerary-topics-card">
                                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                                                <h3 class="h5 mb-0">Temas de <?= htmlspecialchars($selectedItinerary->getTitle(), ENT_QUOTES, 'UTF-8') ?></h3>
                                            ...
                                            <?php if (empty($selectedItinerary->getTopics())): ?>
