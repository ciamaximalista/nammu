...
function nammu_footer_icon_svgs(): array
{
    return [
        ...
        'bluesky' => '<svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M12 3.4c-2.6 2.1-4.7 4.8-5.9 6.8-1.4-1-3.3-2.2-4.9-2.1-.9 0-1.2.6-1 1.6.7 3.5 3.4 5.2 6.4 5.7-3 .5-5.7 2.1-6.4 5.7-.2 1 .1 1.6 1 1.6 1.6.1 3.5-1.1 4.9-2.1 1.2 2 3.3 4.7 5.9 6.8 2.6-2.1 4.7-4.8 5.9-6.8 1.4 1 3.3 2.2 4.9 2.1.9 0 1.2-.6 1-1.6-.7-3.5-3.4-5.2-6.4-5.7 3-.5 5.7-2.1 6.4-5.7.2-1-.1-1.6-1-1.6-1.6-.1-3.5 1.1-4.9 2.1-1.2-2-3.3-4.7-5.9-6.8z"/></svg>',
