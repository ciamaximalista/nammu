...
function nammu_footer_icon_svgs(): array
{
    return [
        ...
        'bluesky' => '<svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M12 6c-2.6-3-6.6-4.3-9-3.2.2 3.6 2.2 6.3 5.6 7.1-3.6.6-5.5 3.6-5.6 7.2 2.4 1 6.4-.3 9-3.3 2.6 3 6.6 4.3 9 3.3-.2-3.6-2.1-6.6-5.6-7.2 3.4-.8 5.4-3.5 5.6-7.1-2.4-1.1-6.4.2-9 3.2z"/></svg>',
