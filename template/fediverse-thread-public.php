...
$deferThreadInteractions = !empty($deferThreadInteractions);
$threadInteractionsFragmentUrl = trim((string) ($threadInteractionsFragmentUrl ?? ''));
...
<div class="fediverse-public-page">
    ...
    <article class="fediverse-public-status<?= $threadStatusVariantClass ?><?= $threadIsOwnNote ? ' fediverse-public-status--note-own' : '' ?>"<?= $threadOwnNoteFontStyle ?>>
        <div class="fediverse-public-status__top">
            ...
            <div class="fediverse-public-status__main">
                ...
                <?php if (!$deferThreadInteractions): ?>
    ...
    <?php if ($deferThreadInteractions && $threadInteractionsFragmentUrl !== ''): ?>
