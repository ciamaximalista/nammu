...
<?php foreach ($itineraries as $itinerary): ?>
            ...
            $itineraryFediverseMeta = is_array($itineraryFediverseMetaBySlug[$itinerary->getSlug()] ?? null) ? $itineraryFediverseMetaBySlug[$itinerary->getSlug()] : [];
            ?>
                ...
                <div class="itinerary-card__body">
                    ...
                    <?php if ($itinerary->getDescription() !== ''): ?>
                        <p class="itinerary-card__description">
                            <?= htmlspecialchars($itinerary->getDescription(), ENT_QUOTES, 'UTF-8') ?><?= $renderFediverseInlineMeta($itineraryFediverseMeta) ?>
                        </p>
                    <?php endif; ?>
                </div>
            </article>
