            ...
            <footer>
                ...
                <?php if ($footerNammuEnabled): ?>
                    <div class="footer-nammu-link">
                        <?= htmlspecialchars($siteTitle, ENT_QUOTES, 'UTF-8') ?> está realizado con <a href="https://ruralnext.org/nammu" target="_blank" rel="noopener">Nammu</a> en <a href="https://ruralnext.org" target="_blank" rel="noopener">RuralNEXT</a>, software libre para el rural.
                    </div>
                <?php endif; ?>
            </footer>
        <?php endif; ?>
