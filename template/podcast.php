            ...
            <article class="<?= htmlspecialchars($cardClass, ENT_QUOTES, 'UTF-8') ?>">
                ...
                <div class="post-body">
                    ...
                    <?php if (!empty($episode['description'])): ?>
                        <p class="post-description"><?= htmlspecialchars($episode['description'], ENT_QUOTES, 'UTF-8') ?><?= $renderFediverseInlineMeta(is_array($episode['fediverse'] ?? null) ? $episode['fediverse'] : []) ?></p>
                    <?php endif; ?>
